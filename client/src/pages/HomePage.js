    ...
    useEffect(() => {
        const getAllTransections = async () => {
            try{
                ...
                console.log(error)
                message.error("error fetching the Transection");
            }
        };
        getAllTransections();
 ...
 // delete Handler
    ...
    const handleDelete = async (record) => {
        try{
            ...
            setLoading(false)
            console.log(error)
            message.error("Unable to Delete Transection");
        }
    };
    ...
    return (
        <Layout>
            ...
            <div className='filters mx-4'>
                ...
                <div className='switch-icons  border-5' >
                        <h6>Analytics</h6>
            ...
            <div className='content'>
                {viewData === 'table' ? (
                    <Table className='mx-4 border border-2 table-color' columns={columns} dataSource={allTransection} />
                ...
                <Form layout='vertical' onFinish={handleSubmit} initialValues={editable}>
                    ...
                    <Form.Item label="Category" name='category'>
                        <Select>
                            ...
                            <Select.Option value='others'>Othes</Select.Option>
                        </Select>
                    </Form.Item>
